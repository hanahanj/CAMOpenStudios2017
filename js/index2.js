...
// SUNDAY CONTENT
var content = [
['<div id=content style=float:right width=100>'+'<h1>Adrian<br>Cox</h1>'+'<p>My paintings employ classical techniques to craft a narrative that explores the lives of the monstrous but peaceful ‘Border Creatures.’</p>'],
['<div id=content>'+'<h1>Albert Yowshien Kuo</h1>'],
['<div id=content>'+'<h1>Alice Gadel</h1>'],
['<div id=content>'+'<h1>Anabun Pottery</h1>'],
['<div id=content>'+'<h1>Andy Leicht</h1>'],
